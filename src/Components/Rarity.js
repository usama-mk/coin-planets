  ...
  return (
    ...
    <div className="flex ">
      <div className="utilityLeft m-10 mt-2 w-[100%] relative">
		...
		<span className="text-[rgba(255,255,124,1)] text-[20px] relative z-10">Coin Plants feature 8 unique properties </span><span className="text-[rgba(255,255,255,1)] relative z-10">with property 1 being a set of 17 beautiful backgrounds and property 8 being extremely rare! <br/><br/>Every other Coin Plant property contains at least </span><span className="text-[rgba(255,255,124,1)] text-[20px]  relative z-10">26 variable colour variations</span><span className="text-[rgba(255,255,255,1)]  relative z-10" > which make up the complete design, each representing the colour scheme of a blue chip Cryptocurrency. <br/><br/>Almost every Coin Plant is randomised, but </span><span className="text-[rgba(123,217,141,1)]  relative z-10">there are a handful of custom 1 of 1 designs</span><span className="text-[rgba(255,255,255,1)]  relative z-10"> amongst collection, so keep an eye out for those!</span>
	</div>
      </div>
